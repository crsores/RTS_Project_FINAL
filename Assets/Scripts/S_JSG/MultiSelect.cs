...
namespace InputManager
{
    ...
    public static class MultiSelect
    {
        ...
        public static void DrawScreenRect(Rect rect, Color color) //그려줌
        {
            GUI.color = color;
            GUI.DrawTexture(rect, whiteTexture);
        }

        public static void DrawScreenRectBorder(Rect rect, float thickness, Color color) //드래그시 모서리부분
        {
            //Top
        ...
        public static Rect GetScreenRect(Vector3 screenPos1, Vector3 screenPos2) //드래그 범위
        {
        ...
        public static Bounds GetVPBounds(Camera cam, Vector3 screenPos1, Vector3 screenPos2)//스크린 좌표 가져오기
        {
